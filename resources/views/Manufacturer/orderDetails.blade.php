                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container"
                                ...
                                <div class="card card-flush py-4" style="margin: 40px;">
                                    ...
                                    <div class="card-body pt-0" >
                                        ...
                                        <img src="{{$order->order_details->DesignImage1Url}}" alt="Italian Trulli" style="width: 240px;">
                                        <img src="{{$order->order_details->DesignImage2Url}}" alt="Italian Trulli" style="width: 240px;margin-left: 70px;">
                                        <img src="{{$order->order_details->DesignImage3Url}}" alt="Italian Trulli" style="width: 240px;margin-left: 70px;">
                                        <img src="{{$order->order_details->DesignImage4Url}}" alt="Italian Trulli" style="width: 240px;margin-left: 70px;">
                                        </div>
                                            <!--begin::Label-->
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                                data-kt-image-input="true" style="justify-content: left">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Cancel-->
                                                    <img src="{{$order->main_fabric->icon_image}}" alt="Italian Trulli" style="height: 120px;width: 120px">
                                                ...
                                                <div style="display:flex">
                                                    ...
                                                    <label class="required form-label" style="margin-left: 18px; margin-top:10px;margin-right:10px">Price</label>
                                                    <!--end::Label-->
                                                ...
                                                <div style="margin-left:50px">
                                                    <label class="required form-label" style=" margin-top:20px;">Description</label>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row fv-plugins-icon-container" style="display:flex">
                                            ...
                                            <input type="number" name="style" class="form-control mb-2"
                                                placeholder="Amount" value="{{$order->order_details->style->style_no}}"
                                                style="width: 170px;width: 170px;margin-right: 50px;" disabled>
                                            <!--end::Input-->
                                            ...
                                            <input type="text" name="stylename" class="form-control mb-2"
                                                placeholder="Style Name" value="{{$order->order_details->style->style_name}}"
                                                style="width: 170px;width: 170px;margin-right: 50px;" disabled>
                                            ...
                                            <input type="text" name="cost" class="form-control mb-2"
                                                placeholder="cost" value="{{$order->order_details->style->size}}"
                                                style="width: 170px;width: 170px;margin-right: 50px;" disabled>
                                                ...
                                                <input type="number" name="cost" class="form-control mb-2"
                                                    placeholder="cost" value="{{$order->order_details->style->manufacuturing_cost}}"
                                                    style="width: 170px;width: 170px;margin-right: 50px;" disabled>
                                ...
                                <div class="card card-flush py-4" style="margin: 40px;">
                                    ...
                                    <div>
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <img src="{{$item->fabrics->icon_image}}" alt="Italian Trulli" style="height: 120px;width: 120px">
                                                ...
                                                <div style="display:flex">
                                                    ...
                                                    <!--begin::Input-->
                                                    <input type="text" name="user" class="form-control mb-2"
                                                        placeholder=" Name" value="{{$item->fabrics->name}}"
                                                        style="width: 170px;" disabled>

                                                    <!--end::Remove-->

                                                    <label class="required form-label" style="margin-left: 18px; margin-top:10px;margin-right:10px">Used For</label>
                                                    <!--end::Label-->

                                                    <!--begin::Input-->
                                                    <input type="text" name="proce" class="form-control mb-2"
                                                        placeholder="price" value="{{$item->used_for}}"
                                                        style="width: 170px;width: 170px;margin-right: 50px;" disabled>
                                    ...
                                    <div>
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <img src="{{$extras->trims->image}}" alt="Italian Trulli" style="height: 120px;width: 120px">
                                                ...
                                                <div style="display:flex">
                                                    ...
                                                    <!--begin::Input-->
                                                    <input type="text" name="user" class="form-control mb-2"
                                                        placeholder=" Name" value="{{$extras->trims->name}}"
                                                        style="width: 170px;" disabled>

                                                    <!--end::Remove-->

                                                    <label class="required form-label" style="margin-left: 18px; margin-top:10px;margin-right:10px">Total Amount</label>
                                                    <!--end::Label-->

                                                    <!--begin::Input-->
                                                    <input type="number" name="proce" class="form-control mb-2"
                                                        placeholder="price" value="{{$extras->total_amount}}"
                                                        style="width: 170px;width: 170px;margin-right: 50px;" disabled>

                                                           <label class="required form-label" style="margin-left: 18px; margin-top:10px;margin-right:10px">Quantity</label>
                                                    <!--end::Label-->

                                                    <!--begin::Input-->
                                                    <input type="number" name="proce" class="form-control mb-2"
                                                        placeholder="Ouantity" value="{{$extras->quantity}}"
                                                        style="width: 170px;width: 170px;margin-right: 50px;" disabled>
                                                </div>
                                                <br>
                                                            ...
                                                            <div data-repeater-item=""
                                                                ...
                                                                <div class="w-100 w-md-200px">
                                                                    <select class="form-select select2-hidden-accessible"
                                                                        ...
                                                                        <option data-select2-id="select2-data-129-ikl4">
                                                                        </option>
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-muted fs-7">Set a list of keywords that the product is
                                                    related to.
                                                    Separate the keywords by adding a comma <code>,</code> between each
                                                    keyword.
                                                </div>
                                                <!--end::Description-->
                                            </div>
