        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                {{-- <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    ...
                    <!--begin::Add product-->
                    <a href={{ route('manufacturer_home.edit',$order->id) }} class="btn btn-primary">
                        Create
                    </a>
                    <!--end::Add product-->
                </div> --}}
            ...
            <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                            ...
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-end min-w-100px sorting" tabindex="0"
                                        aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1"
                                        aria-label="SKU: activate to sort column ascending" style="width: 129.5px;">Customer
                                    </th>
                                    ...
                                    <th class="text-end min-w-100px sorting" tabindex="0"
                                        aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1"
                                        aria-label="Price: activate to sort column ascending" style="width: 129.5px;">Order Amount
                                    </th>
                                ...
                                @foreach ($orders as $order)
                                    <tr class="odd">
                                        ...
                                        <td class="text-end pe-0" data-order="12">
                                            <span class="fw-bold ms-3">{{ $order->designer->name }}</span>
                                        </td>
                                        <td class="text-end pe-0">{{ $order->amount }}</td>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end">
                                {{ $orders->links('admin.custom_pagination') }}
                                </div>
                </div>
            </div>
            <!--end::Table-->
