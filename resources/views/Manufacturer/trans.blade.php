                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row fv-plugins-icon-container" style="display:flex">
                                            ...
                                            <input type="text" name="designer" class="form-control mb-2"
                                                placeholder="Designer Name" value=""
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container"
                                ...
                                <div class="card card-flush py-4" style="margin: 40px;">
                                    ...
                                    <div class="card-body pt-0" >
                                        ...
                                        <img src="https://lynsler.tectrionix.com/assets/images/about.jpg" alt="Italian Trulli" style="width: 240px;">
                                        <img src="https://lynsler.tectrionix.com/assets/images/about.jpg" alt="Italian Trulli" style="width: 240px;margin-left: 70px;">
                                        <img src="https://lynsler.tectrionix.com/assets/images/about.jpg" alt="Italian Trulli" style="width: 240px;margin-left: 70px;">
                                        <img src="https://lynsler.tectrionix.com/assets/images/about.jpg" alt="Italian Trulli" style="width: 240px;margin-left: 70px;">
                                        </div> 
                                            <!--begin::Label-->
                                    ...
                                    <div>
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                                ...
                                                <div>
                                                    <!--begin::Preview existing avatar-->
                                                    <label class="required form-label">Icons</label>
                                                    <div class="image-input-wrapper w-150px h-150px"></div>
                                                    <!--end::Preview existing avatar-->
                                                ...
                                                <div style="margin-left:50px">  
                                                    ...
                                                    <textarea id="w3review" class="form-control mb-2" name="w3review" style="width:280px;height:150px"></textarea>
                                                    <br>
                                                    <div>
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                                ...
                                                <div style="display:flex">
                                                    ...
                                                    <!--begin::Input-->
                                                    <input type="number" name="proce" class="form-control mb-2"
                                                        placeholder="Ouantity" value=""
                                                        style="width: 170px;width: 170px;margin-right: 50px;">
                                                </div>
                                                <br>
                                                <div style="margin-left:50px;display:flex">  
                                                    <label class="required form-label" style="; margin-top:10px;margin-right:10px">Price</label>
                                                    <!--end::Label-->
