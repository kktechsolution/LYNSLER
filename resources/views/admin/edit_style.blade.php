...
<div id="kt_app_content" class="app-content  flex-column-fluid " >
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            <!--begin::Form-->
<form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"  action="{{route('style.update',$style->id)}}" method="POST" enctype="multipart/form-data">
    <!--begin::Aside column-->
    @csrf
    @method('patch')
...
<div class="card card-flush py-4">
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            ...
            <!--begin::Input-->
            <input type="text" name="style_name" class="form-control mb-2"  value="{{$style->style_name}}" required />
            <!--end::Input-->
 ...
 @error('style_name')
        ...
        <div class="mb-10 fv-row">
            ...
            <div class="d-flex gap-3">
                <input type="text" name="style_no" class="form-control mb-2"  value="{{$style->style_no}}" required />
        ...
        <div class="mb-10 fv-row">
            ...
            <!--begin::Input-->
            <div class="d-flex gap-3">
                <input type="text" name="manufacuturing_cost" class="form-control mb-2"  value="{{$style->manufacuturing_cost}}" required />
