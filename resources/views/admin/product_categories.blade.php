                ...
                <div id="kt_app_content" class="app-content  flex-column-fluid ">
                    ...
                    <div id="kt_app_content_container" class="app-container  container-xxl ">
                            ...
                            <div class="card-header border-0 pt-6">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                        <!--begin::Add user-->
                                        <a href={{ route('product_categories.create') }} type="button"
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                    <thead>
                                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-125px">Categorys</th>
                                                    ...
                                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                        <a href="view.html">
                                                            <div class="symbol-label">
                                                                <img src="{{ $category->icon }}" alt="Emma Smith"
                                                                    class="w-100" />
                                                            </div>
                                                        </a>
                                                    </div>
                        ...
                        <div class="m-4 d-flex align-items-center justify-content-center justify-content-md-end">
                            {{ $product_categories->links('admin.custom_pagination') }}
                        </div>
                        <!--end::Card body-->
                    </div>
                    <!--end::Card-->
